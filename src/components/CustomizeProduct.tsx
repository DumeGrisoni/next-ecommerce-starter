    ...
    <section className="flex flex-col gap-6 ">
      ...
      <ul className="flex items-center gap-3">
        ...
        <li className="w-8 h-8 rounded-full ring-gray-300 cursor-not-allowed relative bg-green-500">
          <div className="absolute w-10 h-[2px] bg-red-400 rotate-45 rounded-full ring-2 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
        </li>
      </ul>

      <h4 className="dont-medium">Taille</h4>
      <ul className="flex items-center gap-3">
